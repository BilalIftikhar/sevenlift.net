      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {reasons.map((reason, idx) => {
            ...
            return (
              <Reveal key={reason.title} delay={idx * 90} className="h-full">
                <div className="h-full rounded-xl border border-border bg-background p-7 transition-all hover:-translate-y-1 hover:border-accent/40 hover:shadow-md">
